import { r as registerInstance, f as Build, j as h, m as Host, n as getElement } from './index-0f664595.js';
import { a as isPlatform, c as config, g as getIonMode } from './ionic-global-4ed1374e.js';
    ...
    if (Build.isBrowser) {
      rIC(async () => {
        ...
        if (!config.getBoolean('_testing')) {
          import('./tap-click-d2dc8c3d.js').then(module => module.startTapClick(config));
        }
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-406f6145.js').then(module => module.startStatusTap());
        }
        if (config.getBoolean('inputShims', needInputShims())) {
          import('./input-shims-bfb50582.js').then(module => module.startInputShims(config));
        }
